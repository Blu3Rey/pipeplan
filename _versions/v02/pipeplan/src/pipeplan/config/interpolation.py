...
# Namespaces resolved at *runtime*, not at load time. Tokens in these namespaces
# are left untouched by the loader (even under strict mode) for the execution
# engine to resolve against the live flowing frame.
_DEFERRED_NAMESPACES: frozenset[str] = frozenset({"pipe"})
